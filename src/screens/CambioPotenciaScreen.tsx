...
export default function CambioPotenciaScreen({ navigation }: any) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <Appbar.Header mode="center-aligned" style={{ backgroundColor: theme.colors.primaryContainer }}>
        ...
        <Appbar.Content title="Cambio de Potencia" />
      </Appbar.Header>

      <View style={styles.videoContainer}>
        <Video
          ref={videoRef}
          source={require('../../videos/videos_operatividad/cambio_de_potencia.mp4')}
          style={styles.video}
          paused={isPaused}
