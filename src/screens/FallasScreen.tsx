        ...
        <ScreenEntrance delay={120}>
          <Surface style={[styles.card, { backgroundColor: theme.colors.surface }]} elevation={2}>
            <Card.Content>
              ...
              <Text style={[styles.stepTitle, { color: theme.colors.onSurface }]}>PASO N°1 ingresar al DEVCON.</Text>
              <Image
        ...
        <ScreenEntrance delay={180}>
          <Surface style={[styles.card, { backgroundColor: theme.colors.surface }]} elevation={2}>
            <Card.Content>
              ...
              <Text style={[styles.stepTitle, { color: theme.colors.onSurface }]}>PASO N°5 De clic en aceptar.</Text>
              <Image
                source={require('../../Images/fallas/click_aceptar.png')}
                style={styles.stepImage}
                resizeMode="contain"
